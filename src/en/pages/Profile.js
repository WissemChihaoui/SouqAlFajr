            ...
            <div className="table-row">
              <div className="input-control">
                <div className="input">
                  ...
                  <input
                    type={oldPswHide ? "password" : "text"}
                    placeholder="Old Password"
                  />
                  <Icon
                    icon={
                      oldPswHide ? "mdi:eye-outline" : "mdi:eye-off-outline"
                    }
                    onClick={() => setOldPswHide(!oldPswHide)}
                  />
                </div>
              </div>
            </div>
            <div className="table-row">
              <div className="input-control">
                <div className="input">
                  <Icon icon="mdi:password-outline" />
                  <input
                    type={newPswHide ? "password" : "text"}
                    placeholder="New Password"
                  />
                  <Icon
                    icon={
                      newPswHide ? "mdi:eye-outline" : "mdi:eye-off-outline"
                    }
                    onClick={() => setNewPswHide(!newPswHide)}
                  />
                </div>
              </div>
              <div className="input-control">
                <div className="input">
                  <Icon icon="mdi:password-outline" />
                  <input
                    type={confirmPswHide ? "password" : "text"}
                    placeholder="Confirm Password"
                  />
                  <Icon
                    icon={
                      confirmPswHide ? "mdi:eye-outline" : "mdi:eye-off-outline"
                    }
                    onClick={() => setConfirmPswHide(!confirmPswHide)}
                  />
                </div>
              </div>
            </div>
            <div className="submitBtn table-row">
              <button type="submit" className="table-cell">
                Change Password
              </button>
            </div>
          </form>
