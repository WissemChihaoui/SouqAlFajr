                ...
                <form>
                    <div className='registerInputs'>
                        ...
                        <div className='inputField'>
                            ...
                            <input type={pswHide ? "password" : "text"} placeholder="Password" />
                            <Icon icon={pswHide ? "mdi:eye-outline" :"mdi:eye-off-outline"} onClick={() => setPswHide(!pswHide)}/>
                        </div>
                        <div className='inputField'>
                            <Icon icon="mdi:password-outline" />
                            <input type={rpswHide ? "password" : "text"} placeholder="Confirm password" />
                            <Icon icon={rpswHide ? "mdi:eye-outline" :"mdi:eye-off-outline"} onClick={() => setRpswHide(!rpswHide)}/>
                        </div>
                        <div className='inputField'>
                    ...
                    <div className='submit'>
                        <div className='submitCheck'>
                            <input type={"checkbox"} />
                            <span>I Agree on <a href="#" className='importantText'>terms and conditions</a></span>
                        </div>
